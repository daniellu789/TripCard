...
public class NewMealActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// NewMealFragment
		setContentView(com.levart.mealspotting.R.layout.activity_new_meal);
		FragmentManager manager = getFragmentManager();
		Fragment fragment = manager.findFragmentById(com.levart.mealspotting.R.id.fragmentContainer);

		if (fragment == null) {
			fragment = new NewMealFragment();
			manager.beginTransaction().add(com.levart.mealspotting.R.id.fragmentContainer, fragment)
					.commit();
		}
	}
